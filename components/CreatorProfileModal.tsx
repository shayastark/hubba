                ...
                {(creator.instagram || creator.twitter || creator.farcaster) && (
                  <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '8px' }}>
                    ...
                    {creator.farcaster && (
                      ...
                      >
                        <svg style={{ width: '24px', height: '24px' }} viewBox="0 0 1000 1000" fill="none">
                          <path d="M257.778 155.556H742.222V844.444H671.111V528.889C671.111 440.677 599.633 369.444 511.111 369.444H488.889C400.367 369.444 328.889 440.677 328.889 528.889V844.444H257.778V155.556Z" fill="white"/>
                          <path d="M128.889 253.333L157.778 351.111H182.222V746.667C169.949 746.667 160 756.616 160 768.889V795.556H155.556C143.283 795.556 133.333 805.505 133.333 817.778V844.444H382.222V817.778C382.222 805.505 372.273 795.556 360 795.556H355.556V768.889C355.556 756.616 345.606 746.667 333.333 746.667H306.667V528.889C306.667 428.74 387.129 347.222 488.889 347.222H511.111C612.871 347.222 693.333 428.74 693.333 528.889V746.667H666.667C654.394 746.667 644.444 756.616 644.444 768.889V795.556H640C627.727 795.556 617.778 805.505 617.778 817.778V844.444H866.667V817.778C866.667 805.505 856.717 795.556 844.444 795.556H840V768.889C840 756.616 830.051 746.667 817.778 746.667V351.111H842.222L871.111 253.333H746.667V155.556H253.333V253.333H128.889Z" fill="white"/>
                        </svg>
                      </a>
                    )}
                  </div>
