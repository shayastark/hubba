...
export default function CassettePlayer({ coverImageUrl, isPlaying, title }: CassettePlayerProps) {
  return (
    <div className="relative w-full max-w-md mx-auto mb-6">
      ...
      <div className="relative bg-gradient-to-b from-gray-800 to-gray-900 rounded-xl p-6 shadow-2xl border-2 border-gray-700">
        {/* Cassette Label Area - Shows cover art */}
        <div className="bg-black rounded-lg p-3 mb-4 border-2 border-gray-600 shadow-inner">
          {coverImageUrl ? (
        ...
        <div className="flex justify-between items-center px-4">
          ...
          <div className="relative w-20 h-20">
            <div className="absolute inset-0 rounded-full bg-gray-700 border-4 border-gray-600 shadow-inner"></div>
            <div
            ...
            >
              ...
              {/* Center Hub */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-gray-400"></div>
            </div>
          </div>

          {/* Center Tape Window */}
          <div className="flex-1 mx-4 h-8 bg-gray-900 rounded border-2 border-gray-700 flex items-center justify-center shadow-inner">
